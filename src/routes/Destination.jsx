...
export default function Destination(){
    ...
    const navigation = planetData.map((planet, index) =>(
        <button className={planet.planetName.toLowerCase() === currentPlanet.planetName.toLowerCase()? "destination-nav-button--active" : undefined} onClick={e => handlePlanetChange(e)} key={index}>{planet.planetName}</button>
    ))
    ...
    return(
        <section className="destination">
            ...
            <section className="destination__nav-and-description-container">
                ...
                <p>{currentPlanet.planetDescription}</p>
